...
\begin{figure}[H]
\centering
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_vac/S59/WorldtoKA.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_vac/S59/KAtoCu.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_vac/S59/CutoKA.png}}
\caption{a) Terminus / b) origin / c) terminus of charged particles at 250 MeV for 59 micron Kapton}
\label{fig:G4_stats_vac}
\end{figure}

\begin{figure}[H]
\centering
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_AgKA_vac/S59/WorldtoKA.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_AgKA_vac/S59/KAtoCu.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_AgKA_vac/S59/CutoKA.png}}
...
\begin{figure}[H]
\centering
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA/S59/WorldtoKA.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA/S59/KAtoCu.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA/S59/CutoKA.png}}
\caption{a) Terminus / b) origin / c) terminus of charged particles at 250 MeV for 59 micron Kapton}
\label{fig:G4_stats}
\end{figure}
...
\begin{figure}[H]
\centering
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_AgKA/S59/WorldtoKA.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_AgKA/S59/KAtoCu.png}}
\subfigure{\includegraphics[width=2.5in]{figures/Cu_KA_AgKA/S59/CutoKA.png}}
\caption{a) Terminus / b) origin / c) terminus of charged particles at 250 MeV for 59 micron Kapton with AgKA sheath}
